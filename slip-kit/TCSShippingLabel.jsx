// slip-kit/TCSShippingLabel.jsx
//
// TCS-style label: extra "consignee copy" barcode, ORGN/DSTN row, third
// barcode at the bottom. Node port of the app's client-side renderer.
//
// NOTE: the browser version registered a remote Roboto font. On the server we
// rely on react-pdf's built-in Helvetica instead — avoids a runtime network
// fetch for the font file (the whole point of moving generation server-side).
